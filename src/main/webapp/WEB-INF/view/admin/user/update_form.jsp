...
<main class="container mx-3 my-3">
	...
	<div class="border-top border-2 p-4">
		...
		<form:form action="/admin/user/update" method="POST" modelAttribute="user" class="validcheck" >
		  ...
		  <div class="mb-3">
		    <form:label for="tel" class="form-label"  path="tel">전화번호</form:label>
		    <form:input type="tel" class="form-control" path="tel" placeholder="전화번호 입력" required="true" />
		  </div>
		  <div class="mb-3">
		    <form:label for="email" class="form-label"  path="email">이메일</form:label>
		    <form:input type="email" class="form-control" path="email" placeholder="이메일 입력" required="true" />
		  </div>
