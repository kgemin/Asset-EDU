...
public class UserController extends BaseController {
	...
	@PostMapping("insert")
	public String insert(@ModelAttribute Sys01User user, RedirectAttributes redirectAttr) {
	...
	@PostMapping("update")
	public String update(@ModelAttribute("user") Sys01User user, RedirectAttributes redirectAttr) {
		String pwd = user.getSys01Pwd();
		user.setSys01Pwd(passwordEncoder.encode(pwd));
		service.update(user);
